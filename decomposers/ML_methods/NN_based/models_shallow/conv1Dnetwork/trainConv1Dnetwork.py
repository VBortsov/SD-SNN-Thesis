...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/conv1Dnetwork"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train shallow Conv1D decomposer.")
    ...
    parser.add_argument("--extra-conv-activation", type=str, default="relu", choices=["relu", "gelu", "tanh"])
    parser.add_argument("--extra-conv-norm", type=str, default="none", choices=["groupnorm", "batchnorm", "none"])
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/conv1Dnetwork")
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return ShallowConv1DDecomposer(
