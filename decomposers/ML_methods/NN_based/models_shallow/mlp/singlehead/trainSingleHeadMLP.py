...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/mlp_singlehead"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train single-head shallow MLP decomposer.")
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/mlp_singlehead")
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return SingleHeadMLPDecomposer(
