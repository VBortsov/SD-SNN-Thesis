...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/multiscale_dilated"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train shallow multi-scale dilated decomposer.")
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/multiscale_dilated")
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return ShallowMultiScaleDilatedDecomposer(
