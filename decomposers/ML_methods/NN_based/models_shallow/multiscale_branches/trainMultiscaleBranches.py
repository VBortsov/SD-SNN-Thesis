...
from decomposers.ML_methods.NN_based.models_shallow.multiscale_branches import MultiScaleBranchesDecomposer
...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/multiscale_branches"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train MultiScale Branches decomposer.")
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/multiscale_branches")
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return MultiScaleBranchesDecomposer(
...
def main() -> None:
    ...
    run_training_pipeline(
        ...
        model_name="multiscale_branches",
