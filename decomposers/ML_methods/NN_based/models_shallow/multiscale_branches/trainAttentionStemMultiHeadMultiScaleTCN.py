...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/attention_stem_multi_head_multiscale_tcn"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train the shallow attention-stem multi-head multiscale TCN decomposer.")
    ...
    parser.add_argument("--branch-channels", type=int, default=16)
    parser.add_argument("--fused-channels", type=int, default=48)
    parser.add_argument("--tcn-channels", type=int, default=48)
    ...
    parser.add_argument("--tcn-dilations", type=int, nargs="+", default=(1, 2, 4, 8))
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="decomposers/ML_methods/NN_based/saved_models/attention_stem_multi_head_multiscale_tcn",
    )
...
def main() -> None:
    ...
    run_training_pipeline(
        ...
        model_name="attention_stem_multi_head_multiscale_tcn",
