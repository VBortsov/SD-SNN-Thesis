...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/multiple_head_multiscale_branches"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train Multiple-Head MultiScale Branches decomposer.")
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="decomposers/ML_methods/NN_based/saved_models/multiple_head_multiscale_branches",
    )
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return MultipleHeadMultiScaleBranchesDecomposer(
...
def main() -> None:
    ...
    run_training_pipeline(
        ...
        model_name="multiple_head_multiscale_branches",
