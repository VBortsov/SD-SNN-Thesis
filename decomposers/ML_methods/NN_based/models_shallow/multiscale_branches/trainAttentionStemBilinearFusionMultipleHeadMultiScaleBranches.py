...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/attention_stem_bilinear_fusion_multiple_head_multiscale_branches"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(
        description="Train Attention-Stem Bilinear-Fusion Multiple-Head MultiScale Branches decomposer."
    )
    ...
    parser.add_argument("--bilinear-channels", type=int, default=48)
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="decomposers/ML_methods/NN_based/saved_models/attention_stem_bilinear_fusion_multiple_head_multiscale_branches",
    )
    ...
    return TrainConfig(
        ...
        bilinear_channels=args.bilinear_channels,
...
def create_model(cfg: TrainConfig, device: torch.device) -> nn.Module:
    ...
    """
    return AttentionStemBilinearFusionMultipleHeadMultiScaleBranchesDecomposer(
        ...
        bilinear_channels=cfg.bilinear_channels,
...
def main() -> None:
    ...
    run_training_pipeline(
        ...
        model_name="attention_stem_bilinear_fusion_multiple_head_multiscale_branches",
