...
from decomposers.ML_methods.NN_based.models.rnnbased.rnnbased import RNNDecomposer
...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/rnnbased"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(
        description="Train RNN-based decomposer on synthetic signal decomposition data with checkpointing and integrated evaluation."
    )
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/rnnbased")
