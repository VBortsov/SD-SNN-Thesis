...
class TrainConfig:
    ...
    output_dir: str = "decomposers/ML_methods/NN_based/saved_models/tasnet"
...
def parse_args() -> TrainConfig:
    ...
    parser = argparse.ArgumentParser(description="Train TasNet decomposer on synthetic decomposition data.")
    ...
    parser.add_argument("--skip-dim", type=int, default=128)
    ...
    parser.add_argument("--norm-type", choices=["gln", "cln", "bn"], default="gln")
    ...
    parser.add_argument("--output-dir", type=str, default="decomposers/ML_methods/NN_based/saved_models/tasnet")
